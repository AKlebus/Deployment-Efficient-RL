...
class CartPoleEnv(gym.Env):
    ...
    def __init__(self, max_ep_len, seed, rew_shift=0.0, append=True):
        self.gravity = 9.8
        self.masscart = 1.0
        self.masspole = 0.1
    ...
    def step(self, action):
        ...
        inner_done = self.steps_beyond_done is not None
        return np.array(self.state), reward - self.rew_shift, done, inner_done
